...
export default function Conversation({
  ...
  const { conversationId, title = '', isFrozen = false } = conversation;
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'group relative flex h-11 w-full items-center rounded-lg outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black dark:focus-visible:ring-white md:h-8',
